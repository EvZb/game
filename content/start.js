...
$n=`${btn("next","next('start')")}`;ELM("intro").remove()}else{$tmp="none";$n=`${btn('next',"next('vill')")}`;$t=`You awaken near a village without modern technology.`}
end()})()