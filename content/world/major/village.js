(function () {
    ...
    switch(tmp){
        ...
        case 'leave':
            ...
            n=`\${btn('leave',"tmpr(x,10,'out');pos[2]=1*elm('sdir').value;next('other/explore')")} through the \${lst('sdir',"North:0,Northeast:1,East:2,Southeast:3,South:4,Southwest:5,West:6,Northwest:7")} path | \${btn('back',"tmp=x;next()")}`;break
    }
    end()
})()