(function () {//tmpan is reserved | tmp 0-2 should be unlimited events
    switch(tmp){
        ...
        case '1':
            ...
            tmpa=[$1[3],$1[4],$1[1],$1[0],$1[5],x,'world/terrain/forest','cbt','0',x,tmpan.join()]
        ...
        /*
            switch(tmpa[0]){
                ...
                case 'fall':hp[0]-=10;sbu('hp')
                    if(hp[0]<1){t=`You lose consciousness.`;n=`\${btn("next","tmpa=['faint',w+'terrain/forest','5',0,'wake','${tmpan.join()}'];tmpn=2;next('other/rest')")}`}
                ...
                case 'fight':if(tmpan[1]==1){tmpan[0]=100-tmpan[0]}
                    ...
                    tmpa=['material','Giant Worm teeth.2.5.4.1.5','0.8.4.0.0.4.4.4.20.18.14','Giant Sand Worm','big bite',x,'world/terrain/forest','cbt','0','x',tmpan.join()]
