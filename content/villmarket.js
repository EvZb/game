(function () {let $1=[]
    ...
    if ($tmp != "none") { $1=[1,5,5,5,10,10];if($stat[0]<$1[$tmp]){$t=`You don't have enough money.`}else{$money-=$1[$tmp];switch(Number($tmp)){case 0:$ep=$epm;$hp=$hpm;sbu('hp','ep');break;case 1:iadd('Health Pill--1--+1 max hp--hpx1Xhpmx1--1');
