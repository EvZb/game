(function () {
    ...
    else{let $1 = `\${btn('weak',"$stat[2]+=2;$cbt='5.cityarena';combat([3,1,15,0,1,'Weak Opponent'])")}`;let $2=`\${btn('normal',"$stat[2]+=3;$cbt='15.cityarena';combat([4,2,20,0,1,'Normal Opponent'])")}`;let $3=`\${btn('strong',"$stat[2]+=4;$cbt='25.cityarena';combat([6,2,25,0,1,'Strong Opponent'])")}`
