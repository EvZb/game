(function () {let $1=``;let $2;let $3=``;let $4=``
    ...
    $1+=`<br><br>Money: ${money}<br><br>Attack: ${atk[0]+(afflvl[tech[0]]|0)} hp, ${atk[1]+(afflvl[tech[1]]|0)} ep, ${atk[2]+(afflvl[tech[2]]|0)} sp<br>Defense: ${def[0]} hp, ${def[1]} ep, ${def[2]} sp<br><br>`
