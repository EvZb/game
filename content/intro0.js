(function () {
    ...
    $nvow=['a','an','ang','ao','e','en','eng','ei','i','in','o','ong','u','uo','ua'];$ncon=['b','ch','d','f','g','h','j','k','l','m','n','p','q','qu','r','s','sh','t','v','w','x','y','z'];$itype=['item','consumable','weapon','armor']
    $sect=[['Delectation','Pleasure','Friendship'],['Immortal','Living','Sustainability'],['Sunfire','Leadership','Teamwork'],['Shadow','Secrecy','Knowldge'],['Treasure','Wealth','Treasure'],['Demonic','Power','Sacrafice'],['Moonlight','Individuality','Freedom'],['Snow','Strength','Righteousness'],['Worldly','Protection','Connections']]
